...
plt.title("35. I can insult my spouse when we argue")
...
plt.title("36. I can humiliate my spouse when we argue")
plt.xlabel("Answer to the Survey Question")
plt.ylabel("Number of People")
plt.legend(["Divorce","No Divorce"])
plt.savefig("q36.png")
...
plt.title("40. I start to argue with my spouse before I know what’s going on")
plt.xlabel("Answer to the Survey Question")
plt.ylabel("Number of People")
plt.legend(["Divorce","No Divorce"])
plt.savefig("q40.png")
